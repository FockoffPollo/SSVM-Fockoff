...
playerLines["forceidle"] = {
	...
	"Hopefully it isnt too musky for you in there.",
...
playerLines["requestidle"] = {
	"No wonder why Yharin loves this so much, This feels great!",
	"Hey, Ive heard some preds are able to digest like this. Nasty stuff!",
	"You mind wiggling to the left a little. Ahhh... yes just like that.",
	"Enjoying yourself? I know I am!",
	"Feel free to take a nap in there.",
	"Stay as long as you want, Its not like Im going anywhere.",
	"Want me to stuff a pillow and blanket down there for you?",
	"I think I might have left a rubber ducky in there from last time."
...
playerLines["forceeat"] = {
		"Ahaha! Gotcha!",
		"Hows it hanging? Ahaha!",
		"You seem cold let me help you with that.",
		"Relax, you'll be fine!",
		"Ahhh... That hits the spot.",
		"Try not to squirm too much, Or do!",
		"Looks like your getting the sac!",
...
playerLines["exit"] = {
	...
	"Apoloigies for the unspeakable act of hedonism.",
