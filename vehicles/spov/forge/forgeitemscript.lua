...
defaultDescription = "An unammed lava dragon taur thing."

defaultIcon = "/vehicles/spov/forge/forgedangericon.png"

defaultFrame = "/vehicles/spov/forge/forge.png:idle.1"
