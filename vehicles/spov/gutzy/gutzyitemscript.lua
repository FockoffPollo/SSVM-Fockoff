...
defaultDescription = "One of the last Leathersaurs alive known to mankind."

defaultIcon = "/vehicles/spov/gutzy/gutzydangericon.png"

defaultFrame = "/vehicles/spov/gutzy/gutzy.png:idle.1"
