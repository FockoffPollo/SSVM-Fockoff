...
defaultDescription = "The faithful companion of the Jungle Tyrant. If they can, They will easily swallow you whole."

defaultIcon = "/vehicles/spov/yharon/yharondangericon.png"

defaultFrame = "/vehicles/spov/yharon/yharon.png:idle.1"
