...
defaultDescription = "Be careful. Too nice and she might just keep you."

defaultIcon = "/vehicles/spov/meeba/meebadangericon.png"

defaultFrame = "/vehicles/spov/meeba/meeba.png:idle.1"
