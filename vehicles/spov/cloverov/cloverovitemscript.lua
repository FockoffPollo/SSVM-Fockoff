...
defaultDescription = "The pretty bunnybat babe!"

defaultIcon = "/vehicles/spov/cloverov/cloverovdangericon.png"

defaultFrame = "/vehicles/spov/cloverov/cloverov.png:idle.1"
