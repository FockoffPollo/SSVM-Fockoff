...
defaultDescription = "The hungriest stallion you'll ever meet. Great to ride inside and out!"

defaultIcon = "/vehicles/spov/shadow/shadowdangericon.png"

defaultFrame = "/vehicles/spov/shadow/shadow.png:idle.1"
