...
defaultDescription = "The ravenously toony kitsunecario himself!"

defaultIcon = "/vehicles/spov/deliov/deliovdangericon.png"

defaultFrame = "/vehicles/spov/deliov/deliov.png:idle.1"
